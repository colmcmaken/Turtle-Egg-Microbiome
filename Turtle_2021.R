...
ano = anosim(dat.ra, Turtle_Metadata_2021$Sample.Type, permutations = 9999, distance = "bray", strata = NULL)
ano
...
#Two-Way ANOSIM
SampleType.Species.test <- anosim(dat.ra, Turtle_Metadata_2021$Sample.Type, strata = Turtle_Metadata_2021$Species,
                           permutations = 9999)
Species.SampleType.test <- anosim(dat.ra, Turtle_Metadata_2021$Species, strata = Turtle_Metadata_2021$Sample.Type,
                           permutations = 9999)
SampleType.Species.test
#ANOSIM statistic R: -0.002302 
#Significance: 0.5154 
##Comparing by sample type within each species had no significant differences
...
best.test <- bioenv(dat.ra_sand, metadata_sand_bioenv, trace=TRUE, index = "bray", metric = "euclidean", method = "spearman")
best.test
summary(best.test)
#Mantel Test to estimate significance of best model
tested.dists <- bioenvdist(best.test)
...
best.test <- bioenv(dat.ra_N, metadata_N_bioenv, trace=TRUE, index = "bray", metric = "euclidean", method = "spearman")
best.test
summary(best.test)
#Mantel Test to estimate significance of best model
tested.dists <- bioenvdist(best.test)
