...
2. Feature Table generated using QIIME2 (**feature-table_2021.tsv.txt**)
...
6. Excel files used to create Krona Plots (**Krona Plots** file). To view and interact with Krona Plots: Download file > Enable content/macros > c=Click "Create Chart" > Save as HTML file > Open and Interact!
